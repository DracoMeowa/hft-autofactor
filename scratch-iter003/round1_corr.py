"""iter-003 round 1: pooled Spearman dedup among PASS protos + vs prior PASS6.
...
OUT_JSON = Path("/data/factor_lzt/iterations/iter003_round1_corr.json")
OUT_TXT = Path("/data/factor_lzt/iterations/iter003_round1_corr.txt")

# 19 protos that passed the v2 screen in round 1 (from screen log)
PASS_NEW = [
    "depth5_delta_120s", "depth5_delta_30s", "flow_divergence_120s",
    "flow_divergence_60s", "flow_divergence_x_spread_z", "last_mid_gap_ticks",
    "log_mid_ret_120s", "microprice_dev_mom_60s", "mid_day_range_pos",
    "ofi_z_x_spread_z", "oir_mom_60s", "price_accel_60_180", "signed_rv_60s",
    "top_book_delta_120s", "top_book_delta_30s", "vol_adj_mom_60s",
    "wdi_accel_90s", "wdi_mom_180s", "wdi_mom_30s",
]
# prior PASS6 from the 2026-08-05 rescreen (library members)
PASS_PRIOR = [
