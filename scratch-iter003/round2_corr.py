"""iter-003 round 2: pooled Spearman dedup among 15 PASS protos + vs 22 library.
...
OUT_JSON = Path("/data/factor_lzt/iterations/iter003_round2_corr.json")
OUT_TXT = Path("/data/factor_lzt/iterations/iter003_round2_corr.txt")

# 15 protos that passed the v2 screen in round 2
PASS_NEW = [
    ...
    "conc_imb_mom_60s", "conc_imb_z_300s", "top5_book_div_mom_60s",
    "top5_book_div_z_300s", "iopv_vel_z_300s", "iopv_vel_drift_300s",
]
# 22 admitted library factors (16 round-1 + 6 eval-v2 rescreen)
PASS_PRIOR = [
